...
public:
  ...
  enum {
    ...
    RuleLazyModifier = 13, RuleQuantifierType = 14, RuleRangeDelimiter = 15, 
    RuleRangeQuantifier = 16, RuleRangeQuantifierLowerBound = 17, RuleRangeQuantifierUpperBound = 18, 
